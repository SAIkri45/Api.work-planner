...
export const NAME_TOO_SHORT = "Minimum length of the name is 3 characters";
...
export const PROFILE_PIC_TOO_SHORT = "Minimum length of the profile pic is 5 characters";
...
export const GENDER_INVALID = "Gender must one of the following: MALE, FEMALE, OTHER";
export const GENDER_MISSING = "Gender is missing";
export const ADDRESS_INVALID = "Address must be a string";
export const ADDRESS_TOO_SHORT = "Minimum length of the address is 10 characters";
...
export const LAST_NAME_TOO_SHORT = "Minimum length of the last name is 1 characters";
