...
import type { ValidatedAddUser, ValidatedCreateUserOrAdmin, ValidatedUpdateUser, ValidatedUpdateUserByLoginEmp } from "../validations/schemas/vUserSchema.js";
...
export type UserActivity = "create-user" | "update-user" | "create-user-by-admin" | "update-emp";
