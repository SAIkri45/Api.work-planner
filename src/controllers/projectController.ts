...
class ProjectController {
  ...
  getAllProjects = async (c: Context) => {
    ...
    const finalResponse: ProjectsResponse = { pagination_info: paginationInfo, records: result };
  ...
  getAllTasksByProjectId = async (c: Context) => {
    ...
    const paginationInfo = getPaginationData(page, pageSize, total_records);
    const finalResponse: ProjectTasksResp = { pagination_info: paginationInfo, records: result };
  ...
  getAllProjectUsersList = async (c: Context) => {
    ...
    const paginationInfo = getPaginationData(page, pageSize, total_records);
    const finalResponse: ProjectUsersResponse = { pagination_info: paginationInfo, records: result };
