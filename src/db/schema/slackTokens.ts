...
export type SlackToken = typeof slack_tokens.$inferSelect;
export type NewSlackToken = typeof slack_tokens.$inferInsert;
export type SlackTokensTable = typeof slack_tokens;
