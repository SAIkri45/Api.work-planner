...
// export const MARRIAGE_DATE_MISSING = "Marriage date is required";
...
// export const DELIEVERY_PERCENTAGE_MISSING = "Delivery percentage is required";
// export const COUPON_TOO_SHORT = "Minimum length of the COUPON is 3 characters";
// export const COUPON_MISSING = "Coupon is required";
